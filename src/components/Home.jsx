...
function Home() {
  return (
    <>
      <div className="pt-31 w-full bg-blue-100 px-4 sm:px-6 lg:px-8 p-5">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-start gap-12 mb">
          <div className="w-full lg:w-1/3 mb-8 lg:mb-0 text-center lg:text-left space-y-6">
            ...
            <h1 className="text-3xl text-left sm:text-4xl md:text-5xl font-bold bg-gradient-to-b from-blue-600 to-red-600 bg-clip-text text-transparent leading-tight">Achieve the best version of your health.</h1>
          ...
          <div className="w-full lg:w-1/3 mb-8 lg:mb-0 flex justify-center lg:p-5">
            <img className="max-w-xs sm:max-w-sm md:max-w-md h-120 object-contain rounded-xl  mix-blend-multiply opacity-95" src="luisha3.png" alt="Dr.Luisha"/>
          </div>

          <div className="w-full lg:w-1/3 text-center space-y-6">
            <p className="text-base sm:text-lg bg-green-300 p-4 rounded-2xl leading-relaxed shadow text-gray-800">
