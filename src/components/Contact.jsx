    ...
    <div className='pt-10 px-4 w-full bg-blue-100 pb-10'>
      <div className="flex flex-col lg:flex-row justify-center items-center gap-8 max-w-7xl mx- auto">
        <div className="flex-1 min-w-[300px]">
            ...
            <a href="mailto:gopixelboy@gmail.com" className='text-blue-900 font-semibold block mb-2 hover:underline'>gopixelboy@gmail.com</a>
            <a href="tel:+9779876543210" className='text-blue-900 font-semibold block mb-2 hover:underline'>+977 9876543210</a>
        </div>
