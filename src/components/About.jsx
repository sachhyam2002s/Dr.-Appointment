...
function About() {
  return (
    <>
    <div className='bg-blue-100 pt-24 px-4'>
      <div className="flex flex-col md:flex-row justify-between items-center max-w-6xl gap-8 pb-10 mx-auto">
        <div className="flex justify-center items-center w-full md:w-auto">
            <img src="luisha3.png" alt="" className='w-full max-w-[300px] rounded-[10px] shadow object-cover'/>
        </div>
        <div className="flex-1 min-w-[280px]">
            <h1 className='text-3xl mb-3 font-bold'><b>About Dr. Luisha Shrestha (PT)</b></h1>
            <cite className='text-gray-600 block mb-3'>Physiotherapist</cite>
            <p className='text-lg mb-4'>Dr. Luisha shrestha (PT) is a compassionate and highly skilled physiotherapist dedicated to providing personalised healthcare for patients with ortho neuro cardio and sports injuries. Dr. Luisha Shrestha (PT) is specialized in preventive care, chronic pain management and holistic health solutions.</p>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center max-w-6xl mx-auto pb-10">
